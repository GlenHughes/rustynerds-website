  ...
  return (
    <Layout>
      ...
      <div className="max-w-6xl mx-auto mt-5 justify-between p-6 md:flex">
        ...
        <div className="w-full md:w-1/2 text-center px-3 mt-4 md:mt-0">
      ...
      <div className="max-w-6xl mx-auto mt-0 md:mt-5 justify-between py-0 md:py-6 md:flex">
        <div className="w-full md:w-1/2 text-center px-3">
        ...
        <div className="w-full md:w-1/2 text-center px-3 pb-5 mt-4 md:mt-0">
